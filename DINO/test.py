...
#              sobre modelos DINO entrenados (detección en imágenes
#              de la partición Dataset/test con comparación
#              predicción vs. etiqueta real).
# ==============================================================

"""Punto de entrada CLI para testear modelos DINO ya entrenados.

Visor interactivo orientado a inspección fina de desempeño:
- Carga un modelo DINO (por defecto, variante r50_4scale).
...
def load_model(weights: Path, variant: str, device_str: str, num_classes: int) -> ModelContext:
    ...
    base_args = {
        ...
        'dataset_file': 'coco', 'device': str(device), 'num_classes': num_classes
    }
    ...
    # Intentar cargar el modelo EMA si existe (suele tener mejor rendimiento)
...
def parse_args(argv: Optional[List[str]] = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=str,
        default="r50_4scale",
        help="Variante de la arquitectura DINO (ej. r50_4scale, r50_5scale).",
    )
