...
# [MODIFICADO]: Eliminamos la dependencia de SLConfig (addict/yapf)
...
def get_raw_dict(args):
    ...
    if isinstance(args, argparse.Namespace):
        ...
        return args
    # [MODIFICADO]: Comentamos la evaluación de SLConfig
...
def random_boxes(num=1, scale=1, rng=None):
    ...
    Example:
        ...
        >>> print(boxes)
        tensor([[280.9925, 278.9802, 308.6148, 366.1769],[216.9113, 330.6978, 224.0446, 456.5878],[405.3632, 196.3221, 493.3953, 270.7942]])
    """
    rng = ensure_rng(rng)
