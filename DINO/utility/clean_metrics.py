...
# Autor: Fernando N.
# --------------------------------------------------------------
# Archivo: DINO/utility/clean_metrics.py
...
def main():
    print(f"\n[clean_metrics.py] --- Limpieza de Métricas DINO ---")
    ...
    if v_sel == "all":
        ...
        if confirm == "s":
            ...
            print(f"[clean_metrics.py] ✓ Eliminada carpeta de métricas: {target_dir.relative_to(DINO_ROOT)}")
        else:
            print("[clean_metrics.py] Operación cancelada.")
    else:
