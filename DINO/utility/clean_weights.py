...
# Autor: Fernando N.
# --------------------------------------------------------------
# Archivo: DINO/utility/clean_weights.py
...
WEIGHTS_ROOT = DINO_ROOT / "weights"
...
def main():
    print(f"\n[clean_weights.py] --- Mantenimiento de Pesos Consolidados DINO ---")
    ...
    for c in candidates:
        print(f" - {c.relative_to(DINO_ROOT)}")
    ...
    if input("\n¿Confirma eliminación? (s/n): ").lower() == "s":
        ...
        # Limpieza de carpetas de variantes vacías (ej. weights/r50_4scale si quedó vacía)
