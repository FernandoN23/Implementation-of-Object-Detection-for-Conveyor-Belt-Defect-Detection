...
# Autor: Fernando N.
# --------------------------------------------------------------
# Archivo: DINO/utility/data_loader.py
# Descripción: Adaptador de Dataset YOLOv11 a formato DINO.
...
# Inyectar el submódulo oficial de DINO al PATH
...
try:
    ...
    print(f"[data_loader] ERROR: No se pudo importar desde el submódulo DINO: {e}")
    sys.exit(1)
...
class YoloToDinoDataset(Dataset):
...
def dino_collate_fn(batch):
    """Empaqueta las imágenes en un NestedTensor (con padding y máscaras) para DINO."""
