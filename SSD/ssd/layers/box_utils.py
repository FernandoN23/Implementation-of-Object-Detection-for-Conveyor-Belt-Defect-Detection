...
def nms(boxes, scores, overlap=0.5, top_k=200):
    ...
    # FIX: Eliminar inicialización de tensores vacíos para 'out='
    # xx1 = boxes.new() ... (Eliminado)
    ...
    while idx.numel() > 0:
        ...
        # FIX: Usar asignación directa en lugar de out= para evitar warnings de resize
