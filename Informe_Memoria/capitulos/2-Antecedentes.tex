...
\begin{figure}[H]
    ...
    \subfloat[Desgaste abrasivo bordes banda]{
        \includegraphics[width=0.23\textwidth]{img/2-Antecedentes/Fallas fotos/Desgaste_abrasivo_banda_bordes.png}
    }
    \hfill
    \subfloat[Perforación de banda]{
        \includegraphics[width=0.23\textwidth]{img/2-Antecedentes/Fallas fotos/Perforacion_banda.png}
    }
    \hfill
    \subfloat[Rotura de banda]{
        \includegraphics[width=0.23\textwidth]{img/2-Antecedentes/Fallas fotos/Rotura_banda.png}
    }
    \hfill
    \subfloat[Corte longitudinal ó Desgarro]{
        \includegraphics[width=0.4\textwidth]{img/2-Antecedentes/Fallas fotos/Corte_longitudinal.png}
    }
