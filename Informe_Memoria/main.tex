...
\def\documenttitle {Implementación de Algoritmos de Detección de Objetos para la Identificación de Fallas en Correas Transportadoras}
...
\par En la elaboración de este trabajo de memoria de título se utilizaron herramientas de inteligencia artificial generativa, en particular Google Gemini y sus complementos. Estas fueron empleadas en las Secciones 2, 3 y 6 en la generación de diagramas, código y tablas. Todo el contenido fue revisado y validado por el autor, quien asume plena responsabilidad sobre el trabajo presentado.
